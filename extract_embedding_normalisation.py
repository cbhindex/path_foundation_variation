...
from utils.helper_class_tf import WholeSlideBagTFNorm, WholeSlideBagTF
from utils.helper_functions_tf import resize_transforms, norm_and_resize
...
def process_slide(tile_path, wsi_path, model, batch_size=32):
    ...
    # load tiles
    dataset = WholeSlideBagTF(file_path=tile_path, wsi=wsi, img_transforms=norm_and_resize)
